...
//                    delegate!.addContact(to: nametext, email: "000")
...
//            }
            ...
            if nameTextField.text?.isEmpty == true || phoneNumberTextField.text?.isEmpty == true {
                ...
                self.sendFriendRequest(user_id: MyVariables.user_id!, requested_email: phoneNumberTextField.text!)
            }
    ...
    func sendFriendRequest(user_id: Int, requested_email: String) {
        NetworkManager.sendRequest(user_id: user_id, requested_email: requested_email){ FriendRequest in
            print(FriendRequest?.action_user ?? 111111)
        }
    }
